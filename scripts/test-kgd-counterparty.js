...
(async () => {
  ...
  assert(html.includes('/css/company-check.css?v=20260815-4'), 'Page stylesheet is missing');
  assert(html.includes('/js/site.js?v=20260815-1'), 'Shared site script cache key is stale');
