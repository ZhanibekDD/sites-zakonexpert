...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayResults(data) {
        ...
        if (debtors && debtors.length > 0) {
                ...
                card.innerHTML = `
                    ...
                    <div class="ip-list-body">
                        ...
                        <div class="ip-list-meta">
                            ...
                            ${debtorAmount > 0 ? `<span class="ip-chsi-fee"><b>Услуга ЧСИ</b> <a href="https://wa.me/77058762795?text=${encodeURIComponent('Здравствуйте! Хочу убрать проценты ЧСИ, прошу помочь.')}" target="_blank" rel="noopener" class="ip-save-link">— убрать проценты ЧСИ →</a></span>` : ''}
            ...
            const waAllUrl = `https://wa.me/77058762795?text=${encodeURIComponent(waAllText)}`;
            ...
            // No arrests found
            debtorsSection.style.display = 'block';
            const waNoArrestUrl = `https://wa.me/77058762795?text=${encodeURIComponent('Здравствуйте! Проверил(а) по ИИН — арестов не найдено, но у меня есть вопрос по задолженности.')}`;
            debtorsContainer.innerHTML = `
    ...
    function showErrorMessage(message) {
        ...
        const waUrl = `https://wa.me/77058762795?text=${encodeURIComponent(T.waPrefix)}`;
