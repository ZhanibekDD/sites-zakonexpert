(function initializeSiteShell() {
  ...
  // The shared shell can be included or initialized more than once by legacy pages.
  if (window.__ZE_SITE_SHELL_INITIALIZED__) return;
  window.__ZE_SITE_SHELL_INITIALIZED__ = true;
